...
# AT THIS POINT THERE IS A RUNNIG DATABASE AND DATA ACCESS OBJECT WHICH IS A PATH TO DB


#HERE WE HAVE AN ARRAY OF COMMANDS OBJECTS EACH OF THESE HAS A COPY OF THE DATA ACCESS OBJECT AND HENCE DATABASE
commands = [
